    ...
    public partial class ControlPanel : Form
    {
        ...
        public void screenCapture(bool showCursor)
        {
            ...
            if (ScreenPath!=""||ScreenShot.saveToClipboard)
            {
                ...
                if (ScreenShot.saveToClipboard)
                {
                    ...
                    MessageBox.Show("Screen saved to clipboard", "HCM", MessageBoxButtons.OK);

                }
                else
                {

                    MessageBox.Show("Screen saved to file", "HCM", MessageBoxButtons.OK);
        ...
        private void bttTips_Click(object sender, EventArgs e)
        {
            if (TipsShowing)
            {
                ...
                ControlPanel.ActiveForm.Height = 140;
            ...
            else
            {
                ...
                ControlPanel.ActiveForm.Height = 300;
